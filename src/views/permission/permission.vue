    ...
    <div id="app" class="app-container">
        ...
        <div>
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="permissionName" label="名称" min-width="10%" />
...
<script>
import permissionJs from './permission.js';
import addPermission from './componment/addPermission.vue';
import detailsPermission from './componment/detailsPermission.vue';
import editPermission from './componment/editPermission.vue';
export default {
    name: 'permission',
    components: {
        addPermission,
