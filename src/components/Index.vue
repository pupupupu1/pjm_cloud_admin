    ...
    <div class="index-vue">
        ...
        <section class="sec-right">
            ...
            <div class="top-c">
                <header>
                    <div class="h-left">
                        <div class="pointer" @click="isShrinkAside" title="收缩/展开"><Icon type="ios-apps" /></div>
                        <!-- 面包屑功能 -->
                    ...
                    <div class="h-right">
                        ...
                        <!-- 用户头像 -->
                        <div class="user-img-c"><img :src="userImg" /></div>
                        <!-- 下拉菜单 -->
                ...
                <div class="div-tags">
                    ...
                    <!-- 标签栏相关功能 -->
                    <div class="div-icons">
                        <div class="refresh-c" @click="reloadPage" title="刷新当前标签页"><Icon type="md-refresh" /></div>
            ...
            <div class="main-content">
                <div class="view-c">
                    ...
                    <div class="loading-c" v-show="showLoading"><Spin size="large"></Spin></div>
                </div>
            </div>
        </section>
    </div>
