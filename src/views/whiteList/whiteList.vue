    ...
    <div id="app" class="app-container">
        ...
        <div>
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="filterName" label="名称" min-width="10%" />
                <el-table-column :show-overflow-tooltip="true" prop="filterCode" label="编号" min-width="10%" />
                <el-table-column :show-overflow-tooltip="true" align="center" label="类型" min-width="10%">
                    <template slot-scope="scope">
                      <!-- {{ scope.row.msgStatus }} -->

                      <el-tag v-show="scope.row.filterType == '1'" type="success">应用</el-tag>
                      <el-tag v-show="scope.row.filterType == '2'" type="info">接口</el-tag>
...
<script>
import whiteListJs from './whiteList.js';
import addWhiteList from './componment/addWhiteList.vue';
import editWhiteList from './componment/editWhiteList.vue';
export default {
    name: 'permission',
    components: {
        addWhiteList,
